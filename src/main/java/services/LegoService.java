...
public class LegoService {
    ...
    public String getValues() {
        ...
        return lego.getId() + "#" + lego.getRun() + "#" + lego.getSpeed() + "#" + lego.getTurn() + "#" + lego.getParkingMode() + "#" + lego.getObstacleDistance() + "#" + lego.getInfo();
    }
    ...
    public List<Lego> getAll() {
        EntityManager em = emf.createEntityManager();
        em.getTransaction().begin();
        Query q = em.createQuery("select s from Lego s order by s.id desc");
        List<Lego> list = q.getResultList();
        em.getTransaction().commit();
        return list;
    }
